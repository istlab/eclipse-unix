...
public class PackageExplorerMainMenuView extends CompoundContributionItem {

  private static final Logger logger = Logger.getLogger(PackageExplorerMainMenuView.class);
  ...
  public static void setCommandID(int commandID) {
    PackageExplorerMainMenuView.commandID = commandID;
  }
  ...
  public static void setCommands(List<Command> commands) {
    PackageExplorerMainMenuView.commands = commands;
  }
  ...
  public static void setHandlers(List<IHandlerActivation> handlers) {
    PackageExplorerMainMenuView.handlers = handlers;
  }
  ...
  private class CustomCommandExecutionHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
      ...
      controller.addCommand(this.customCommand);
